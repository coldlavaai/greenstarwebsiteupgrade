      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden p-3 rounded-lg transition-colors text-white hover:text-[#8cc63f]"
            style={{
              minWidth: '48px',
              minHeight: '48px',
              display: 'flex',
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="md:hidden mt-4 rounded-lg shadow-xl overflow-hidden border border-white/10"
              style={{
