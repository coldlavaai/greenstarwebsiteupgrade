...
const Testimonials = ({ data }: TestimonialsProps) => {
  ...
  // All 48 reviews - Google and Trustpilot mixed together
  const allReviews: Testimonial[] = [
    ...
    { name: 'Anonymous', rating: 5, text: 'Fantastic experience from start to finish! Professional, friendly team. Excellent communication. Top-notch quality. Finished on time with no issues!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Greenstar were professional throughout. Kept us updated with the plan. Never put any pressure on us. Checked we are happy and helped set up the app.', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'They did such a good job! Great professional team, worked hard to get the job completed in a timely manner and efficiently.', platform: 'Trustpilot' },
    { name: 'Alex Customer', rating: 5, text: 'Found Alex really easy to deal with. No pushy tactics. Knows his stuff, seamless installation process and quality work all round.', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Competitive quote—not the cheapest but fair. High standard work. Scaffolding removed quickly. Already noticing significant energy savings!', platform: 'Google' },
    ...
    { name: 'Anonymous', rating: 5, text: 'Superb customer service and quality installation. Communication was excellent. Quality of work and attention to detail were top-notch!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Professional service from first consultation to installation. Knowledgeable team that listened to our needs. Excellent value for money.', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Jack was fantastic - knowledgeable, professional, always willing to answer questions. Installation went smoothly. Already seeing reduced costs!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Excellent explanation of how system worked. Quote adjusted to meet my needs. Install was quick and well done. Already saving money!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Jon\'s initial proposal was great. Jack helped with amended solution. Tobias moved things smoothly. Tom, Anthony and Ben did first rate install!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Whole team looks after you from start to finish. Clean tidy and professional. Great price and quality of work and products!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'After lots of research found an honest local company with no pressure. Professional and straightforward. Delighted after a month!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Jon made sure I was comfortable with every decision. Tobias kept me updated from start to finish. Exceptional service!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Very smooth process. Good advice at initial meeting. Professional neat installation. Very good communication throughout.', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'Spoke with several companies - Greenstar was completely different. Knowledgeable technicians not salesmen. Seamless from start to finish!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'They took us through the contract and explained processes. All completed within a day. Superb nice people - highly recommend!', platform: 'Trustpilot' },
    { name: 'Anonymous', rating: 5, text: 'System performing exactly as hoped. Install went as planned. Install team were nice guys and tidy as they worked.', platform: 'Trustpilot' },
  ];
    ...
    <section ref={ref} id="testimonials" className="py-24 bg-transparent relative overflow-hidden">
      ...
      <div className="container mx-auto px-8 md:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 tracking-tight" style={{ fontFamily: 'var(--font-heading)' }}>
            What Our{' '}
